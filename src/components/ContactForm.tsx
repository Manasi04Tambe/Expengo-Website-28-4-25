            ...
            {/* <div className="flex items-center space-x-4">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <img 
                    key={i}
                    src={`https://images.pexels.com/photos/2379${i}05/pexels-photo-2379${i}05.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2`} 
                    alt={`Client ${i}`} 
                    className="w-10 h-10 rounded-full border-2 border-white object-cover"
                  />
                ))}
              </div>
              <p className="text-sm text-gray-600">Joined by 500+ fleet operators</p>
            </div> */}
          </div>

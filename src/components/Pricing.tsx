      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`relative p-8 rounded-3xl overflow-hidden transform transition-all duration-500 hover:scale-105 hover:-translate-y-2 hover:shadow-2xl bg-white border ${plan.isPopular ? 'ring-2 ring-teal-500 shadow-lg' : 'border-gray-200 shadow-sm'} animate-fade-up delay-[${index*100}ms]`}
            >
              {plan.isPopular && (
